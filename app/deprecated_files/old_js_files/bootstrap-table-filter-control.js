	...
	*/
	  ...
	  $.each(that.columns, function (_, column) {
	    ...
	    if (column.filterData && column.filterData.toLowerCase() !== 'column') {
	      ...
	      if (filterDataType) {
			...
			console.log("HERE IS THE FILTER DATA SOURCE STUFF")
			...
			console.log("Does this say filterdatatype?")
	...
	var filterDataMethods = {
	  func: function func(filterDataSource, selectControl, filterOrderBy, selected) {
		...
		console.log("this is variableValues Window:")
	  ...
	  obj: function obj(filterDataSource, selectControl, filterOrderBy, selected) {
		...
		console.log("This is variableName:")
		console.log(variableName);
		console.log('This is window by itself:')
		console.log(window)
		console.log(window['headerStyle'])
		var variableValues = window[variableName];
		console.log(variableValues)
		console.log(window[variableName])
		console.log("THAT WAS THE FIRST SET OF LOGS")

		console.log(obj)
		console.log(objectKeys)
		console.log(objectKeys.length)
		console.log("IS THIS TRUE?")
		console.log(objectKeys.length > 0)
		console.log("WAS THAT TRUE?")
		console.log("FOR REAL?")
	    if (objectKeys.length > 0) {
	      objectKeys.forEach(function (key) {
			  if (objectKeys == undefined) return;
			  console.log(key)
